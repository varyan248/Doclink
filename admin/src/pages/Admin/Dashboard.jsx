    ...
    dashData && (
      <div className="m-5 w-full">
        ...
        <div className="bg-white mt-6 rounded-lg border border-gray-200 shadow-sm overflow-hidden">
          ...
          {/* ── Table Header ── */}
          <div className="hidden sm:grid grid-cols-[2.5fr_2.5fr_1.5fr_1.5fr_1fr_1fr] px-6 py-3 border-b border-gray-100 bg-gray-50/50 text-xs font-semibold text-gray-500 uppercase tracking-wider">
            <p>Doctor</p>
            <p>Patient</p>
            <p>Date</p>
            <p>Time</p>
          ...
          <div className="max-h-[50vh] overflow-y-auto">
            {filteredAppointments.length === 0 ? (
              ...
              filteredAppointments.map((item, index) => {
                ...
                return (
                  <div
                    className="grid grid-cols-1 sm:grid-cols-[2.5fr_2.5fr_1.5fr_1.5fr_1fr_1fr] items-center px-6 py-3.5 gap-2 sm:gap-3 border-b border-gray-50 hover:bg-blue-50/30 transition-colors"
                    key={item._id || index}
                  >
                    {/* Doctor */}
