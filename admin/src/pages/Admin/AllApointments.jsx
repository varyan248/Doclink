...
const AllApointments = () => {
  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='hidden sm:grid grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1.5fr_1fr] grid-flow-col py-3 px-6 border-b'>
          <p>#</p>
          <p>Patient</p>
          <p>Age</p>
          <p>Date & Time</p>
        ...
        {appointments.map((item, index) => {
          ...
          return (
          <div className='grid grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1.5fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50' key={index}>
